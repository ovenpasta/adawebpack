...
--  WASM variant: bare "raise;" in cleanup-and-rethrow patterns replaced with
--  last-chance handler call. WASM exception propagation does not support
--  re-raising from an exception handler.
