...
--  This is the native WebAssembly EH (back-end ZCX) variant of the standalone
--  tlsf System: exception propagation IS supported, via funclet EH lowered to
--  wasm try/catch/throw.  Hence No_Exception_Propagation is NOT set here and
--  Frontend_Exceptions/ZCX_By_Default below select back-end ZCX.
